...
<div class="container mt-5">
    <div class="mb-5 pt-5 text-center">
        <h3 class="heading neonText">About Davie Kava</h3>
    </div>
    <div class="row">
    ...
    <div class="mb-5 pt-5 text-center">
        <h3 class="heading neonText">What is Kava?</h3>
    </div>
    <div class="mb-5">
        <div class="mb-5 text-center">
            <img src="img/specialty-drinks/kava-shell.png" alt="davie kava logo" width="300" height="325">
        </div>
        <p>
            The Rise of Kava Bars in the US
        </p>
        <p>
    ...
    <div class="mb-5 pt-5 text-center">
        <h3 class="heading neonText">What are Happy Teas?</h3>
    </div>
    <div class="mb-5">
        <div class="mb-5 text-center">
            <img src="img/specialty-drinks/red-happy-tea.png" alt="davie kava logo" width="300" height="325">
        </div>
        <p>
    ...
    <div class="mb-5 pt-5 text-center">
        <h3 class="heading neonText">Meet Our Staff!</h3>
    </div>
